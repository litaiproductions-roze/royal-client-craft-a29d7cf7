...
export function Footer() {
  ...
  return (
    <footer className="gradient-dark text-primary-foreground md:pl-72">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-[1.2fr_1fr_1fr] md:items-start">
          ...
          <div className="flex flex-col items-center md:items-start gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs tracking-wider text-primary-foreground/70">Building Digital Excellence</p>
              </div>
            </div>
            ...
            <ul className="flex flex-wrap justify-center gap-x-6 gap-y-2">
              {footerLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.path}
                    className="text-sm font-medium text-primary-foreground/85 underline-offset-4 transition-colors hover:text-accent hover:underline"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          <div className="flex flex-col items-center md:items-end gap-2">
            <p className="text-sm text-primary-foreground/85">Ready to build something amazing?</p>
            <Link
              to="/contact"
        ...
        {/* Bottom Bar */}
        <div className="mt-12 space-y-5 border-t border-primary-foreground/15 pt-6">
            ...
            {socialIcons.map(({ key, icon: Icon, label }) => {
              ...
              return (
                <a
                  ...
                  aria-label={label}
                  className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-primary-foreground/20 bg-primary-foreground/5 text-primary-foreground transition-colors hover:border-accent/60 hover:bg-primary-foreground/10 hover:text-accent"
                >
